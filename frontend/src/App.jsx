...
export default function App() {
  ...
  const handleGeneratePlan = async () => {
    ...
    try {
      ...
      setMessages((current) => [
        ...current,
        { role: 'assistant', content: `He preparado un plan con ${data.test_cases.length} casos de prueba.` },
      ]);
    } catch (err) {
      ...
      <main className="conversation-area">
        ...
        <section className="chat-content">
          ...
          <div className="bottom-actions">
            <button className="plan-button" onClick={handleGeneratePlan} disabled={!sessionId || isLoading}>
              <span>✦</span> Generar plan de pruebas
            </button>
          </div>
